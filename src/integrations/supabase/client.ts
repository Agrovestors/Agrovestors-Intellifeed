...
function createSupabaseClient() {
  ...
  const VITE_SUPABASE_PUBLISHABLE_KEY = import.meta.env.VITE_VITE_SUPABASE_PUBLISHABLE_KEY || process.env.VITE_SUPABASE_PUBLISHABLE_KEY;
  ...
  return createClient<Database>(VITE_SUPABASE_URL, VITE_SUPABASE_PUBLISHABLE_KEY, {
    global: {
      fetch: createSupabaseFetch(VITE_SUPABASE_PUBLISHABLE_KEY),
    },
    auth: {
